                            ...
                            <div class="table-responsive">
                                <table class="table nomargin">
                                    ...
                                    <tr>
                                        ...
                                        &lt;!&ndash;  <th class="text-right">State</th>
                                          <th class="text-right">City</th>&ndash;&gt;
                                        <th>Action</th>
                                    </tr>
                                    </thead>
                                    <tbody>
...
<script>
    ...
    import {getTransactionsForAdmin} from '../utilities/settings'
    export default {
        data() {
            return {
                authUser: {},
        ...
        methods: {
            ...
            myTransaction(page_url) {
                ...
                page_url = page_url || getTransactionsForAdmin
